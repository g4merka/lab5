...
$xls = new PHPExcel();
$xls->getProperties()->setTitle("Населенные пункты");
$xls->getProperties()->setSubject("lab5");
$xls->getProperties()->setCreator("ФИО");
$xls->getProperties()->setCompany("USATU");
$xls->getProperties()->setCategory("PI31*");
$xls->getProperties()->setKeywords("Населенные пункты");
